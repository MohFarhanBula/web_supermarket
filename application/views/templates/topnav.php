<nav class="sb-topnav navbar navbar-expand navbar-dark shadow-sm" style="background: #5c7d7c !important;">
    <button class="btn btn-link btn-sm" id="sidebarToggle" href="#">
        <i class="fas fa-bars fa-fw font-weight-bold text-white"></i>
    </button>
    <a class="navbar-brand order-lg-first text-sm-center font-weight-bold" href="<?= base_url(); ?>">Warung IT</a>
    <!-- Navbar-->
